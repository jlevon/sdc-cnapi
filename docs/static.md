...
| **dapi.changeDefaults.filter_capness**      | String | true         | Whether CPU cap settings are cross-checked.                               |
...
| **ALLOC_FILTER_CAPNESS**       | Boolean | true    | Whether CPU cap settings are cross-checked.                                  |
